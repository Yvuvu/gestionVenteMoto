(function($) {
  ...
  $.fn.expandyMenu = function(options) {
    var defaults = {
      button: $('#toggle'),
      duration: 500,
      easing: 'easeOutCubic',
  ...
  this.Menu = function(container, settings) {
    ...
    this.uniqueRandoms = [];
    this.updateStyle();
    this.random = settings.toggleRandom;
    this.delay = settings.toggleDelay;
    /* Start events */
    this.initEvents();
  ...
  Menu.prototype.calculateItemSizes = function() {
    ...
    this.itemMinSize = 
      (containerSize - this.itemMaxSize) / (numItems - 1);
  };
  ...
  Menu.prototype.expand = function(index) {
    ...
    if (this.$container.width() < 
        this.settings.minContainerWidth) {
  ...
  Menu.prototype.toggle = function() {
    ...
    var $container = this.$container,
      ...
      self = this,
      randomIndex,
      callback = this.settings.callback.onMenuToggle;
