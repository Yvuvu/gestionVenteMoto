...
<body>
    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <!-- <li><a href="enregistrer.php">Enregistrer</a></li> -->
          <li class="active"><a href="enregistrer.html"><i class="fa fa-plus"></i>&nbsp;Enregistrer</a></li>
            ...
            <div class="col-md-6 mb-4">
                <fieldset class="fieldcadre">
                    <div class="input-group champinput">                        
                        ...
                        <input type="text" class="form-control inputborder" id="validationServerUsername" name="serialNumber" placeholder="entrer la marque de moto..." aria-describedby="inputGroupPrepend3" required>                        
                    </div>
                </fieldset>
            </div>
            <div class="col-md-6 mb-4">
                <fieldset class="fieldcadre">
                    <div class="input-group champinput">
                        ...
                        <input type="text" class="form-control inputborder" id="validationServerUsername" name="brand" placeholder="entrer le modàle de moto..." aria-describedby="inputGroupPrepend3" required>
                    </div>
                </fieldset>
                </div>
        </div>
            ...
            <div class="col-md-6 mb-4">
                <fieldset class="fieldcadre">
                    <div class="input-group champinput">
                        ...
                        <input type="text" class="form-control inputborder" id="validationServerUsername" name="model" placeholder="entrer la valeur du cylindre..." aria-describedby="inputGroupPrepend3" required>
                    </div>
                </fieldset>
            </div>
            <div class="col-md-6 mb-4">
                <fieldset class="fieldcadre">
                    <div class="input-group champinput">
                        ...
                        <input type="text" class="form-control inputborder" id="validationServerUsername" name="cylinder" placeholder="entrer la catégorie de la moto..." aria-describedby="inputGroupPrepend3" required>
                    </div>
                </fieldset>
            </div>
        </div>
            ...
            <div class="col-md-6 mb-4">
                <fieldset class="fieldcadre">
                    <div class="input-group champinput">
                        ...
                        <input type="text" class="form-control inputborder" id="validationServerUsername" name="category" placeholder="entrer le numéro de serie..." aria-describedby="inputGroupPrepend3" required>
                    </div>
                </fieldset>
            </div>
            <div class="col-md-6 mb-4">
  ...
  <!-- ======= Footer ======= -->
  <footer id="footer" class="fixed-bottom" data-aos="" data-aos-easing="" data-aos-duration="500">
    ...
    <div class="container">
      <div class="copyright">
        ...
        Designed by <span class="design">Binôme 12</span>
      </div>
      <div class="credits">
